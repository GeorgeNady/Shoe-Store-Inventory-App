    ...
    init {
        val list = mutableListOf(
            Shoe(
                ...
                listOf(R.drawable.shoes_1)
            ),
            Shoe(
                "Swift Run W",
                43.0,
                "Adidas",
                "Make a break for the finish line with the adidas® Originals Swift Run W sneaker.",
                listOf(R.drawable.shoes_2)
            ),
            Shoe(
                "Jefferson (Little Kid/Big Kid)",
                30.5,
                "Native Shoes Kids",
                "NA",
                listOf(R.drawable.shoes_3)
            ),
            ...
            Shoe(
                ...
                30.5,
                "Reebok Lifestyle",
                "Bring classic tennis style to your wardrobe with the Reebok® Lifestyle Club C 85 sneakers",
